interface EnqueueableInterface<T> {
...
declare class ReadableStreamDefaultController<R = ArrayBufferView> implements EnqueueableInterface<R> {
...
declare class TransformStreamDefaultController<R> implements EnqueueableInterface<R> {
  enqueue(chunk: R): void
